...
var openEye = appUrl + "/themes/front/images/svgs/ic_eye.svg";
var closeEye = appUrl + "/themes/front/images/svgs/ic_eye-off.svg";
...
$(() => {
    ...
    inputPasswordIcon.on("click", (e) => {
        ...
        var currentPasswordField =
            currentElementIcon.parentElement.previousElementSibling;
